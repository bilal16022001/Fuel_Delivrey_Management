  ...
  return (
    ...
    <SideBarOwner/>
       ...
       <div className='content'>
             ...
             <h2 className="text-center mb-3">Confirmed Orders</h2>
            <div className="">
             <div className="table-responsive">
                 <table className="main-table text-center table table-bordered">
                     ...
                     {OrdersFuel.filter(it => it.fuel_station.Owner_id == OwnerId && it.Statuts==1).map(item => (
                        <tr>
                          <td>{item.id}</td>
